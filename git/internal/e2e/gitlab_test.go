...
import (
	...
	"gitlab.com/fluxcd/go-git-providers/gitlab"
	"gitlab.com/fluxcd/go-git-providers/gitprovider"
	"gitlab.com/fluxcd/pkg/git"
	"gitlab.com/fluxcd/pkg/git/gogit"
	"gitlab.com/fluxcd/pkg/git/libgit2"
	. "gitlab.com/onsi/gomega"
)
